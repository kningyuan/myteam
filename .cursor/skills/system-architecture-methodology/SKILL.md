...
description: >-
  ...
  Use when designing system architecture, choosing architecture patterns, writing
  system-design or architecture-review deliverables, or when the user asks for
  架构方法论、ADR、C4、六边形、端口化、trade-off、质量属性.
---
...
写入 `docs/decisions/NNN-<slug>.md`，模板见 `business/skills/system-architecture-methodology/references/adr-template.md`。
