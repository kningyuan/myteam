...
from adapter.core.protocol import AdapterCapabilities, ModelInfo, RunRequest
from common.delivery.submit_result import DISPATCH_TOKEN_ENV
from adapter.core.subprocess_cli import SubprocessCLIAdapter

from adapter.claude.parser import parse_line
from adapter.claude.skill_sync import sync_workspace_skills
from adapter.claude.mcp_sync import sync_workspace_mcp, MCP_CONFIG_NAME
...
class ClaudeCodeAdapter(SubprocessCLIAdapter):
    ...
    def _build_run_command(self, request: RunRequest) -> list[str]:
        ...
        if request.agent_id:
            from common.agent.agent_skills import get_agent_skill_ids
