...
import common.paths as hub_paths  # noqa: E402
import common.store.store as cstore  # noqa: E402
import common.project.project_admin as padmin  # noqa: E402
...
def test_cancel(client, tmp_path, monkeypatch):
    ...
    seed.close()
    monkeypatch.setattr(cstore, "Store", lambda *a, **k: orig(db))
    from common.project.project_runtime import reset_project_runtime
