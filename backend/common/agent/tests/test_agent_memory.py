...
from memstack.l1 import (  # noqa: E402
...
from memstack.l1.native import NativeAgentMemory  # noqa: E402
from config_store.sessions import SessionStore  # noqa: E402
...
def test_clear_group_does_not_touch_dm_session(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("config_store.sessions.session_store", store)
