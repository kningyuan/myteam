...
from common.agent.agent_id_policy import (  # noqa: E402
...
from common.process.plan_gate import check_plan  # noqa: E402
...
def test_check_plan_accepts_researcher_after_alias(monkeypatch):
    monkeypatch.setattr(
        "common.agent.agent_registry.agent_task_type_map",
...
def test_assert_auto_create_rejects_unknown(monkeypatch):
    monkeypatch.setattr(
        "common.agent.agent_id_policy.allowed_auto_create_ids",
