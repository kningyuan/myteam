...
from common.skill.skill_link import (  # noqa: E402
...
def test_ensure_vendor_replaces_stub(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "common.skill.skill_link.VENDOR_SKILL_SOURCES",
        {"browse": [str(vendor)]},
    )
...
def test_resolve_skill_source_prefers_business_dir(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("common.skill.skill_link.SKILLS_DIR", skills_dir)
    monkeypatch.setattr("common.skill.skill_link.VENDOR_SKILL_SOURCES", {})
...
def test_sync_cursor_skill_links(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("common.skill.skill_link.SKILLS_DIR", business)
