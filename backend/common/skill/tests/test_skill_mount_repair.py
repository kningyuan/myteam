...
from adapter.claude.skill_sync import sync_workspace_skills  # noqa: E402
from common.skill.skill_catalog import canonical_skill_mount_id  # noqa: E402
from common.skill.skill_categories import create_skill_category, move_skill_to_category  # noqa: E402
from common.skill.skill_link import resolve_skill_source_dir  # noqa: E402
...
def skills_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("common.skill.skill_catalog.SKILLS_DIR", skills_dir)
    monkeypatch.setattr("common.skill.skill_categories.SKILLS_DIR", skills_dir)
    monkeypatch.setattr("common.skill.skill_link.SKILLS_DIR", skills_dir)
    return skills_dir
...
def test_move_skill_remounts_workspace_symlink(skills_env, tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("common.agent.agent_registry.REGISTRY_FILE", registry_path)
    monkeypatch.setattr("hub.services.agent_registry.WORKSPACES_DIR", workspaces)
    monkeypatch.setattr("common.paths.WORKSPACES_DIR", workspaces)
    ...
    monkeypatch.setattr("common.agent.adapter_skill_registry.sync_agent_skills_to_cli", _sync_cli)

    cursor_root = tmp_path / ".cursor" / "skills"
    monkeypatch.setattr("common.skill.skill_link.CURSOR_SKILLS_DIR", cursor_root)
