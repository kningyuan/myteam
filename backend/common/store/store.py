...
from common.store.store_backend import StoreBackend
from common.store.store_sqlite import SQLiteStoreBackend
...
class Store:
    ...
    def import_task_data(self, project_id: str, data: Optional[dict] = None) -> dict:
        ...
        if data is None:
            from common.store.task_data_store import read_task_data
