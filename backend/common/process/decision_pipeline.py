...
from common.agent.agent_bootstrap import auto_create_agent
from common.agent.agent_id_policy import (
    normalize_agent_ids,
...
from common.process.plan_splice import normalize_subtasks, validate_subtasks
from common.process.plan_gate import check_plan
from common.process.process_types import BudgetExceededError, ProcessConfig
from common.paths import workspace_dir
from common.prompt.prompt_templates import render_kind_intent
...
def _list_agent_ids(store: Store) -> list[str]:
    ...
    try:
        from common.agent.agent_transport import _load_agents_config
...
class DecisionPipeline:
    ...
    def _suggest_best_agent(self, task_type: str, agents: list[str]) -> str:
        ...
        if not agents:
            return ""
        try:
            from common.gate.quality_suggest import suggest_agent_for_task
