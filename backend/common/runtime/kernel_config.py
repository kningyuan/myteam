...
from common.agent.agent_port import WatchdogConfig
...
def kernel_configs_for_run(
    ...
    *,
    ...
    if defaults is None:
        from common.skill.skill_settings import process_defaults, skill_config_all

        defaults = process_defaults()
        executor = (skill_config_all() or {}).get("executor") or {}
    else:
        from common.skill.skill_settings import skill_config_all
