...
from common.agent.agent_port import AgentPort, WatchdogConfig, reconcile_on_start
from common.observability.observability import BudgetConfig, check_budget
from common.process.process import Process, ProcessConfig, ProjectOutcome
...
def run_project(project_id: str, *, goal: str = "", title: str = "",
    ...
    loops = None
    if workflow:
        from common.workflow.workflow_bootstrap import ensure_workflow_ready
        from common.runtime.goal_template import apply_goal_template_defaults
