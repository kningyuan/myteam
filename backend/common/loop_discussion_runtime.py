...
def group_enabled(project_id: str = "") -> bool:
    try:
        from common.workflow_collaboration import project_group_enabled
...
def workflow_group_discussion_enabled(project_id: str) -> bool:
    try:
        from common.workflow_collaboration import group_discussion_enabled
...
def workflow_discussion_profile_id(project_id: str) -> str:
    try:
        from common.workflow_collaboration import loop_discussion_profile_id
