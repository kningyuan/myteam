...
from common.delivery_templates import DeliveryTemplateError, list_delivery_template_ids, load_delivery_template
from common.gate import check_format
from common.goal_template import apply_goal_template_defaults, parse_goal_template_id
...
def test_delete_template_blocked_when_workflow_references():
    from common.delivery_template_store import delete_template, workflows_using_template
    import pytest
