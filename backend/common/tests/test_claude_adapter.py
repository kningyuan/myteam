...
from adapter.protocol import RunRequest  # noqa: E402
from adapters.claude.adapter import ClaudeCodeAdapter, _runtime_settings_json  # noqa: E402
...
def test_build_run_command_includes_rules_and_mcp(tmp_path, adapter, monkeypatch):
    ...
    import common.agent_skills as skills_mod
...
def test_runtime_settings_includes_user_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("adapters.claude.adapter.Path.home", lambda: home)
